...
class TVSeriesTilePage extends StatefulWidget {
  TVSeriesTilePage({required this.movieData, required this.items});
  ...
  @override
  State<TVSeriesTilePage> createState() => _TVSeriesTilePageState();
}

class _TVSeriesTilePageState extends State<TVSeriesTilePage> {
  @override
