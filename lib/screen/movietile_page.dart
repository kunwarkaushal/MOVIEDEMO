...
class MovieTilePage extends StatefulWidget {
  MovieTilePage({required this.movieData, required this.items});
  ...
  @override
  State<MovieTilePage> createState() => _MovieTilePageState();
}

class _MovieTilePageState extends State<MovieTilePage> {
  @override
